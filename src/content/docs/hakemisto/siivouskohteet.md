...
Tunnetut bloatware- ja orpotiedostokaavat on kerätty Vaiheen 1 skripteista 03 ja 18. Järjestelmäskanneri (`phase1-unslopify/01-scan-system.ps1`) käyttää näitä tunnistakseen jäänteet. Kaikki polut käyttävät ympäristömuuttujia.
